...
type Summary = { requestNumber: string; status: string; createdAt: string; updatedAt: string; productType?: "MEDICATION" | "MEDICAL_DEVICE"; medications: Array<{ commercialName: string; concentration: string; tabletQuantity: number }>; medicalDevices?: Array<{ name: string; brand: string | null; model: string | null; quantity: number | null }>; hasQuote: boolean };
